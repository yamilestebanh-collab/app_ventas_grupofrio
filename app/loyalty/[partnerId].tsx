/**
 * Programa de Lealtad screen — Puntos, nivel y beneficios del cliente
 */
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content}>
        <Card>
          ...
          <Text style={[typography.body, { textAlign: 'center' }]}>Programa de Lealtad</Text>
          <Text style={[typography.dim, { textAlign: 'center', marginTop: 4 }]}>
            Puntos, nivel y beneficios del cliente
          </Text>
